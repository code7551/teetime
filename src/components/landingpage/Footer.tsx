...
const quickLinks = [
	...
	{ label: "ทีมผู้สอน", href: "#pros" },
	{ label: "หลักสูตร", href: "#programs" },
	{ label: "ราคา", href: "#pricing" },
	{ label: "จุดเด่น", href: "#why-us" },
	{ label: "ติดต่อ", href: "#contact" },
];

export function Footer() {
	return (
		<footer className="bg-[#1C0A10] text-gray-400">
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
				<div className="grid grid-cols-1 md:grid-cols-4 gap-10">
					<div className="md:col-span-2">
						<div className="flex items-center gap-3 mb-4">
							<div className="w-10 h-10 rounded-xl bg-linear-to-br from-[#800020] to-[#6B1528] flex items-center justify-center">
								<span className="text-white font-bold text-lg">T</span>
							</div>
							<span className="font-bold text-xl text-white tracking-tight">
								Teetime
								<span className="text-amber-400"> Golf Center</span>
							</span>
						</div>
						<p className="text-gray-400 leading-relaxed max-w-sm">
							สถาบันพัฒนาทักษะกอล์ฟระดับพรีเมียม
							ด้วยทีมโปรที่ได้รับการรับรองจาก PGA Thailand
							พร้อมหลักสูตรเฉพาะบุคคลเพื่อพัฒนาเกมของคุณอย่างเป็นระบบ
						</p>
					</div>
					<div>
				...
				<div className="mt-12 pt-8 border-t border-white/6 text-center text-sm text-gray-500">
