...
interface IncomeBookingsTableProps {
  ...
  /** If provided, shows a "โปรโค้ช" column */
...
export default function IncomeBookingsTable({
  ...
  const columns = useMemo<ColDef[]>(() => {
    ...
    if (showProColumn) cols.push({ key: "pro", label: "โปรโค้ช" });
    cols.push(
    ...
    if (showActions) cols.push({ key: "action", label: "จัดการ", className: "text-center" });
    return cols;
      ...
      case "status":
        return (
          <div className="text-center">
            <Chip size="sm" variant="flat" color={isPaid ? "success" : "warning"}>
